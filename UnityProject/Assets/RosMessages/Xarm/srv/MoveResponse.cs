...
namespace RosMessageTypes.Xarm
{
    ...
    public class MoveResponse : Message
    {
        ...
        public MoveResponse(short ret, string message)
        {
            this.ret = ret;
            this.message = message;
        }

        public static MoveResponse Deserialize(MessageDeserializer deserializer) => new MoveResponse(deserializer);

        private MoveResponse(MessageDeserializer deserializer)
        {
