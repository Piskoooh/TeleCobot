...
namespace PcxRosPointcloud2
{
    ...
    class PlyImporter : ScriptedImporter
    {
        ...
        public enum CoordinateType { LeftHanded, RightHanded }

        [SerializeField] ContainerType _containerType = ContainerType.Mesh;
        [SerializeField] CoordinateType _coordinateType = CoordinateType.LeftHanded;
        ...
        DataBody ReadDataBody(DataHeader header, BinaryReader reader)
        {
            ...
            for (var i = 0; i < header.vertexCount; i++)
            {
                ...
                if (_coordinateType == CoordinateType.LeftHanded) data.AddPoint(x, y, z, r, g, b, a);
                else data.AddPoint(-y, z, x, r, g, b, a);
            }
